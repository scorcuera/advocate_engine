      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="ml-auto flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-200 rounded-lg text-sm text-red-600 hover:bg-red-100 transition-colors font-semibold"
          >
            <X className="w-4 h-4" />
            Réinitialiser
          </button>
